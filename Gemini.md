...
graph TD
    ...
    Client -- 3. Submits own encrypted/plain vote --> RTDB
...
*   **[config.js](file:///Users/vitaliimarchenko/workplace/planning-poker-app/config.js):** Houses environment configurations including the `firebaseConfig` credentials and the `APPS_SCRIPT_URL` endpoint.
...
### 2. Apps Script Actions & CORS Preflight Bypass
...
### 4. Smart Database Cleanup (Purging Storage)
